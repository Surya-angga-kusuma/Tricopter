...
void mapremote()
{
  ...
  yaw_input   = 
  pitch_input = 0;
  if (roll_channel > 1507){roll_input=roll_channel-1507;}else if(roll_channel < 1487){roll_input=roll_channel-1487;}  roll_input =constrain(roll_input,-489,489); roll_input /= 10.9; 
  if (pitch_channel > 1507){pitch_input=pitch_channel-1507;}else if(pitch_channel < 1487){pitch_input=pitch_channel-1487;} pitch_input =constrain(pitch_input,-486,486); pitch_input /= 10.8;
  if (yaw_channel > 1504){yaw_input=yaw_channel-1504;}else if(yaw_channel < 1484){yaw_input=yaw_channel-1484;} yaw_input =constrain(yaw_input,-491,491); yaw_input /= 10,9;
